...
| 16 | [use-cases/16-landing-takeoff-pad-docking.md](use-cases/16-landing-takeoff-pad-docking.md) | Controlled landing + takeoff (pad docking) foundation | pending | 2026-09-18 |

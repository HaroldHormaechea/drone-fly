...
| 37 | [use-cases/37-floor-start-and-survival-reward.md](use-cases/37-floor-start-and-survival-reward.md) | Floor start + airborne survival reward (learn to take off and stay up) | pending | 2026-09-20 |

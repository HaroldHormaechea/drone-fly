...
| 29 | [use-cases/29-partial-anatomy-position-cap-fix.md](use-cases/29-partial-anatomy-position-cap-fix.md) | Partial-anatomy connectomes above the spectral cap must still provision positions | in-progress | 2026-09-19 |

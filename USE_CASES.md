...
| 34 | [use-cases/34-viewer-drop-time-heatmap.md](use-cases/34-viewer-drop-time-heatmap.md) | Viewer: remove the neurons×time heatmap (anatomical brain map is the only heatmap) | in-progress | 2026-09-20 |

...
| 55 | [use-cases/55-inner-loop-rate-controller.md](use-cases/55-inner-loop-rate-controller.md) | Inner-loop body-rate controller (acro flight controller) | in-progress | 2026-09-23 |

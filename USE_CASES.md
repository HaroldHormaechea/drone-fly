...
| 20 | [use-cases/20-macos-sim-setup-automation.md](use-cases/20-macos-sim-setup-automation.md) | Automated macOS real-physics sim setup (prebuilt pybullet, no source build) | in-progress | 2026-09-18 |

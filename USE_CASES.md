...
| 32 | [use-cases/32-windows-tui-parallel-training.md](use-cases/32-windows-tui-parallel-training.md) | Windows: full-screen live TUI with per-second updates, logs pane, and crash-free parallel training | in-progress | 2026-09-20 |
